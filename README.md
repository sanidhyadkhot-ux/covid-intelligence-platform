...
![Skills](https://img.shields.io/badge/SQL-JOINs%20%7C%20CTEs%20%7C%20Window%20Functions-green)
...
![Executive Command Center](outputs/dashboard_screenshots/01_product_style_executive_command_center.png)

### Global Monitoring Center

![Global Monitoring Center](outputs/dashboard_screenshots/02_global_monitoring_center.png)

### Vaccination Intelligence Hub

![Vaccination Intelligence Hub](outputs/dashboard_screenshots/03_vaccination_intelligence_hub.png)

### AI Insights Center

![AI Insights Center](outputs/dashboard_screenshots/04_ai_insights_center.png)

### SQL + Tableau Workflow Story

![SQL Tableau Workflow](outputs/dashboard_screenshots/05_sql_tableau_workflow_story.png)
